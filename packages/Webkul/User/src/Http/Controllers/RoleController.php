...
class RoleController extends Controller
{
    ...
    public function store()
    {
        ...
        // $role = $this->roleRepository->create(request()->all());  Before changing

        // Changing  start
        $role = $this->roleRepository->create(['name' => strtolower(request()->name),
    ...
    public function update($id)
    {
        ...
        // $role = $this->roleRepository->update(request()->all(), $id); // Before Change ..


        // Changing  start
        $role = $this->roleRepository->update(['name' => strtolower(request()->name),
        'permission_type' => request()->permission_type,
        'description' => request()->description,
        'permissions' => request()->permissions,
    ] , $id );
