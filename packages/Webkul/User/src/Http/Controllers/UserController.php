...
use Webkul\User\Repositories\AddressRepository;
use Webkul\User\Repositories\DriverRepository;
use Webkul\User\Repositories\CompanyRepository;
...
class UserController extends Controller
{
     ...
     * RoleRepository object
     *
     * @var \Webkul\User\Repositories\AddressRepository
     */
     ...
     * RoleRepository object
     *
     * @var \Webkul\User\Repositories\DriverRepository
     */
     ...
     * RoleRepository object
     *
     * @var \Webkul\User\Repositories\CompanyRepository
     */
    ...
    public function store(UserForm $request)
    {
        ...
        $user = Admin::createAdmin($request->all());
...
//        $admin = $this->adminRepository->update($data, $id);
        $admin = Admin::updateAdmin($data,$id);
